...
public class DomainException extends Exception {
  ...
  /**
   * Creates a new customized exception.<br>
   * In case the template key {@code i18nKey} contains any placeholder, they must be included in the {@code i18nArgs}.
   *
   * @param i18nKey  Key to translate the exception message
  ...
  /**
   * Creates a new customized exception, including the exception {@code cause} that caused this domain exception.
   * Also includes a short message {@code message} explaining the reason.<br>
   * In case the template key {@code i18nKey} contains any placeholder, they must be included in the {@code i18nArgs}.
   *
   * @param i18nKey  Key to translate the exception message
   * @param i18nArgs Arguments to replace in the exception message placeholder
  ...
  /**
   * Creates a new customized exception, including the original exception that caused this domain exception.<br>
   * In case the template key {@code i18nKey} contains any placeholder, they must be included in the {@code i18nArgs}.
   *
   * @param i18nKey  Key to translate the exception message
   * @param i18nArgs Arguments to replace in the exception message placeholder
